# Generated by Django 2.2.3 on 2019-07-25 18:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Um nome curto que sera usado para identifica-lo de forma unica na plataforma', max_length=30, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-]+$'), 'informe um nome de usuario validoEste valor dev conter apenas letras, numeros e os caracteres: @/./+/-/_ .', 'invalid')], verbose_name='Apelido / Usuario')),
